...
<head>
    ...
    <title>Add New Cake - Admin</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="page-header">
            <h1 class="mb-2"><i class="fas fa-plus-circle"></i> Add New Cake</h1>
            <p class="text-muted mb-0">Fill in the details to add a new cake to the catalog</p>
        </div>
        
        <!-- Add Cake Form -->
        <div class="form-container">
            <form action="AddCakeServlet" method="post">
                <div class="row">
                    <!-- Cake Name -->
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="cakeName" name="cakeName" 
                               placeholder="e.g., Chocolate Truffle Cake" required>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="price" name="price" 
                               step="0.01" min="0" placeholder="e.g., 599.00" required>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" 
                                  rows="4" placeholder="Enter cake description..."></textarea>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="imagePath" name="imagePath" 
                               placeholder="https://via.placeholder.com/400x300/FFB6C1/8B4513?text=Cake+Name">
                        <small class="text-muted">Leave blank to use placeholder image</small>
                    </div>
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-success btn-lg">
                            <i class="fas fa-save"></i> Add Cake
                        </button>
