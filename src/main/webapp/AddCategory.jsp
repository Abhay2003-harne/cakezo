...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="page-header">
            <h1 class="mb-2"><i class="fas fa-plus-circle"></i> Add New Category</h1>
            <p class="text-muted mb-0">Create a new category for organizing cakes</p>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="categoryName" name="categoryName" 
                               placeholder="e.g., Birthday Cakes, Wedding Cakes" required>
                    </div>
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <textarea class="form-control" id="description" name="description" 
                                  rows="4" placeholder="Enter category description (optional)..."></textarea>
                    </div>
